...
// Update navbar based on login status - NO REGISTER BUTTON FOR CUSTOMERS
function updateNavbar() {
  const navButtons = document.getElementById('navButtons');
  const heroCta = document.getElementById('heroCtaBtn');
  
  if (isLoggedIn()) {
    // Show ONLY dashboard button
...
// Also check when returning to page (in case of back/forward navigation)
